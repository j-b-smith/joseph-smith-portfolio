    ...
    <Box className="w-full lg:w-1/2 flex-shrink-0 bg-white shadow-lg rounded-lg p-4 sm:p-6" data-cy="contact-info-card">
      ...
      <Grid templateColumns="repeat(2, 1fr)" gap={6} mb={4}>
        <Button
          ...
          data-cy="email-link"
          leftIcon={<EmailIcon />}
          onClick={() => GoogleAnalytics.trackLinkClick("Email - Contact Info Card")}
        >
          Email
        </Button>
        ...
        <Button
          ...
          leftIcon={<FaGithub />}
          data-cy="github-link"
          onClick={() => GoogleAnalytics.trackLinkClick("GitHub - Contact Info Card")}
        >
          GitHub
        </Button>
        ...
        <Button
          ...
          onClick={() => GoogleAnalytics.trackLinkClick("LinkedIn - Contact Info Card")}
        >
          LinkedIn
        </Button>
        ...
        <Button
          ...
          leftIcon={<PhoneIcon />}
          data-cy="phone-link"
          onClick={() => GoogleAnalytics.trackLinkClick("Phone - Contact Info Card")}
        >
          (812) 314-1581
        </Button>
      </Grid>
