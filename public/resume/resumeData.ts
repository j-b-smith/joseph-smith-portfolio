    ...
    experience: [
      {
        ...
        technologies: ["PHP", "Selenium", "PHPUnit", "Behat", "JIRA", "Docker", "Ansible", "Composer"],
      },
      {
        company: "Routable",
        role: "QA Engineer",
        ...
        technologies: ["Cypress", "Playwright", "Python", "BDD", "TypeScript", "JIRA", "Docker", "GitLab"],
      },
      {
        company: "Sharpen",
        role: "QA Engineer",
