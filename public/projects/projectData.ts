...
export const projectData: ProjectData[] = [
  {
    ...
    customTitle: 'Brute Force Study App',
    summary: 'A NextJS application I\'ve been building to help my girlfriend study for college courses.',
  ...
  },
  {
    ...
    summary: 'This was my capstone project for my software engineering course. It uses Java, JavaFX, and MySQL database.',
    technologies: ['Java', 'JavaFX', 'MySQL'],
  },
  {
